\chapter{Modèles EF pour le comportement dans le plan des tissus et composites tissés }
...
\begin{itemize}[label=\textbullet]
	...
	\item Modèle més-oscopique qui coutent chère en temps de calcul si on veut simuler toute la structure
